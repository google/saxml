import google3.third_party.pybind11_abseil.status
...
class CustomModel:
    ...
    @overload
    def Custom(self, request: bytes, method_name: str, options: ModelOptions = ...) -> bytes: ...
    def CustomNoException(self, request: bytes, method_name: str, options: ModelOptions = ...) -> google3.third_party.pybind11_abseil.status.Status | bytes: ...
    def CustomStream(self, request: bytes, method_name: str, callback: Callable, options: ModelOptions = ...) -> None: ...
