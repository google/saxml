...
class VisionModel:
    ...
    def Detect(self, image_bytes: str, text: list[str] = ..., boxes: list[tuple[float,float,float,float]] = ..., options: ModelOptions = ...) -> list[tuple[float,float,float,float,bytes,float]]: ...
